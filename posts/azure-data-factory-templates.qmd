...
description: "Open access and reusable design documentation of pipelines used in the NHSX Analytics Azure Data Factory (ADF) environment."
date: "2021-09-09"
...
- [SQL Database Ingestion Pipeline](#sql-database-ingestion-pipeline)
- [Databricks Ingestion Pipeline](#databricks-ingestion-pipeline)
- [Excel Sheet Ingestion Pipeline](#excel-sheet-ingestion-pipeline)
- [Multiple Excel Sheet Ingestion Pipeline](#multiple-excel-sheet-ingestion-pipeline)
- [Web URL Data Ingestion Pipeline](#web-url-data-ingestion-pipeline)
- [Azure Function App Ingestion Pipeline](#azure-function-app-ingestion-pipeline)
- [SharePoint Ingestion Pipeline](#sharepoint-ingestion-pipeline)
- [Databricks Processing Pipeline](#databricks-processing-pipeline)
- [Azure Function App Processing Pipeline](#azure-function-app-processing-pipeline)
- [Multiple Azure Function Apps Processing Pipeline](#multiple-azure-function-apps-processing-pipeline)
- [Copy File Processing Pipeline](#copy-file-processing-pipeline)
- [SQL Table Staging Pipeline](#sql-table-staging-pipeline)
- [Multiple SQL Table Staging Pipeline](#multiple-sql-table-staging-pipeline)
...
![Data ingestion from a SQL database](/assets/images/pipeline_temps/sql-ingest.png)
...
![Data ingestion using a databricks notebook](/assets/images/pipeline_temps/databricks/databricks.png)
...
![Data ingestion of an excel file sheet](/assets/images/pipeline_temps/excel_sheet_ingestion.png)
...
![Data ingestion of multiple excel file sheets](/assets/images/pipeline_temps/multiple_excel_sheet_ingestion.png)

*Figure 4: Data ingestion of multiple excel file sheets*

![ForEach loop activities within pipeline](/assets/images/pipeline_temps/multiple_excel_sheet_ingestion_2.png)
...
![Copy activity wildcard setup](/assets/images/pipeline_temps/multiple_excel_sheet_ingestion_3.png)
...
![Data ingestion from a web URL](/assets/images/pipeline_temps/web_url_ingestion.png)
...
![Data ingestion using an azure function app](/assets/images/pipeline_temps/function_app_ingestion.png)
...
![Data ingestion from microsoft sharepoint](/assets/images/pipeline_temps/sharepoint_ingestion.png)
...
![Data processing using a Databricks notebook](/assets/images/pipeline_temps/databricks/databricks.png)
...
![Data processing using an azure function app](/assets/images/pipeline_temps/function_app_processing.png)
...
![Data processing using multiple azure function apps](/assets/images/pipeline_temps/multiple_function_app_processing.png)

*Figure 12: Data processing using multiple azure function apps*

![ForEach loop activities within pipeline](/assets/images/pipeline_temps/multiple_function_app_processing_2.png)
...
![Copying a .csv file between Azure Datalake directories](/assets/images/pipeline_temps/csv_file_processing.png)
...
![Data staging to a table in an Azure SQL database](/assets/images/pipeline_temps/sql_database_staging.png)
...
![Data staging to multiple tables in an Azure SQL database](/assets/images/pipeline_temps/multiple_table_sql_database_staging.png)

*Figure 16: Data staging to multiple tables in an Azure SQL database*

![ForEach loop activities within pipeline](/assets/images/pipeline_temps/multiple_table_sql_database_staging_2.png)
