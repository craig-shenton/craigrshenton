...
description: "In this post, we aim to set out the data engineering principles NHSX has developed in designing and building our Azure cloud-analytics infrastructure."
date: "2021-09-01"
layout: post
categories: [Azure]
---
...
Our principles are broken down into the following sections:

- Azure Data Engineering Principles
	- [Parameterisation](#parameterisation)
		- [Example: latestFolder](#example-latestfolder)
	- [Configuration-as-code](#configuration-as-code)
	- [Standardised ETL Design Patterns](#standardised-etl-design-patterns)
		- [Example 1: SQL Database Ingestion Pipeline](#example-1-sql-database-ingestion-pipeline)
		- [Example 2: Databricks Processing Pipeline](#example-2-databricks-processing-pipeline)
...
![Figure 1. An Azure Data Factory dataset file path configuration using the parameters; `@dataset().fileSystem`, `@dataset().filePath`, `@dataset().fileName` to denote the datalake file system name, the file path and and the file name.](/assets/images/posts/azure-data-engineering-principles/fig1.png)
...
![Figure 2. An example Azure Data Factory pipeline utility that can append the source path of any file with the latest time-stamped folder path.](/assets/images/posts/azure-data-engineering-principles/fig2.png)
...
![Figure 3. An example Azure Data Factory ingestion pipeline template that can be configured to extract data from an Azure SQL database to Azure Datalake blob storage.](/assets/images/posts/azure-data-engineering-principles/fig3.png)
...
![Figure 4. An example Azure Data Factory pipeline processing pipeline template that can be configured to run a Databricks notebook.](/assets/images/posts/azure-data-engineering-principles/fig4.png)
...
![Figure 5.A hierarchicy of pipelines. At the top, a orchestration pipeline that triggers the sub-pipelines below. Each phase of the data processing (extract, transform, and load, or ETL) is a fully parameterised template that requires no setup of its own.](/assets/images/posts/azure-data-engineering-principles/fig5.png)
