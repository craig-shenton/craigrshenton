...
![An Azure Data Factory dataset file path configuration.](/assets/images/posts/azure-data-engineering-principles/fig1.png)

<b>Figure 1.</b> An Azure Data Factory dataset file path configuration using the parameters; `@dataset().fileSystem`, `@dataset().filePath`, `@dataset().fileName` to denote the datalake file system name, the file path and and the file name.
...
![An example Azure Data Factory pipeline utility that can append the source path of any file with the latest time-stamped folder path.](/assets/images/posts/azure-data-engineering-principles/fig2.png)
...
![An example Azure Data Factory ingestion pipeline template that can be configured to extract data from an Azure SQL database to Azure Datalake blob storage.](/assets/images/posts/azure-data-engineering-principles/fig3.png)
...
![An example Azure Data Factory pipeline processing pipeline template that can be configured to run a Databricks notebook.](/assets/images/posts/azure-data-engineering-principles/fig4.png)
...
![A hierarchicy of pipelines. At the top, a orchestration pipeline that triggers the sub-pipelines below.](/assets/images/posts/azure-data-engineering-principles/fig5.png)
